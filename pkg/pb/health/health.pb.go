...
type HealthCheckResponse struct {
	...
	Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=api.analytics.ingester.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
}
...
var file_health_health_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x16, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x6e, 0x61, 0x6c, 0x79,
	0x74, 0x69, 0x63, 0x73, 0x2e, 0x69, 0x6e, 0x67, 0x65, 0x73, 0x74, 0x65, 0x72, 0x22, 0x2e, 0x0a,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0xa4, 0x01,
	...
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x39, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x6e, 0x61, 0x6c,
	...
	,
...
var file_health_health_proto_goTypes = []interface{}{
	(HealthCheckResponse_ServingStatus)(0), // 0: api.analytics.ingester.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: api.analytics.ingester.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: api.analytics.ingester.HealthCheckResponse
}
var file_health_health_proto_depIdxs = []int32{
	0, // 0: api.analytics.ingester.HealthCheckResponse.status:type_name -> api.analytics.ingester.HealthCheckResponse.ServingStatus
	1, // 1: api.analytics.ingester.Health.Check:input_type -> api.analytics.ingester.HealthCheckRequest
	2, // 2: api.analytics.ingester.Health.Check:output_type -> api.analytics.ingester.HealthCheckResponse
...
func (c *healthClient) Check(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.analytics.ingester.Health/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Health_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.analytics.ingester.Health/Check",
	}
...
var _Health_serviceDesc = grpc.ServiceDesc{
	ServiceName: "api.analytics.ingester.Health",
